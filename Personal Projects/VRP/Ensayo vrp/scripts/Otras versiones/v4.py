...
def solve_vrp(data, time_limit=30):
    ...
    if 'vehicle_capacities' in data:  # CVRP case
        ...
        # Ensure each vehicle is used by setting a maximum number of nodes per vehicle
        ...
        for vehicle_id in range(data['num_vehicles']):
            ...
            distance_dimension.SetCumulVarSoftUpperBound(index, 0, 100000)
